...
public class Parser {
    ...
    public Query handleQueryStatement(ZQuery s, TransactionId tId)
        ...
        // the part below will invoke the QueryPlanVisualizer if it is available.  it uses Java
        // Reflection to check whether the class is there and gracefully skip this step if the
        // needed classes are not available.
